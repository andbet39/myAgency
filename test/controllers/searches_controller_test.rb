...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { keyword: @search.keyword, last_run: @search.last_run, zona: @search.zona } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { keyword: @search.keyword, last_run: @search.last_run, zona: @search.zona } }
